                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex">                                                        
                                                    ...
                                                    <!-- 일반 사용자 게시물인지, 관리자 게시물인지에 따라 선택 옵션을 다르게 만듦 -->
                                                    <?php
                                        ...
                                        <tr>
                                            <td>                                                        
                                                ...
                                                while($row = mysqli_fetch_assoc($sql)){
                                                    $filepath_array = unserialize($row['att_file']); // 직렬화하여 저장했던 첨부파일 경로 배열을 불러오기 위해 역직렬화함
                                                }
                                                
                                                for($i=0; $i<count($filepath_array);$i++){ // 역직렬화한 첨부파일 경로를 통해 기존에 게시물에 들어가 있는 첨부파일들의 목록을 출력함
