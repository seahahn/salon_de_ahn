					...
					<div class="container">                        
						...
						<div class="row"> <!-- 메인 글 영역-->
							<div class="col" id="content">
                                ...
                                <div id="board_write">
                                    <form name="write" id="write" action="write_ok_itpf.php" method="post" enctype="multipart/form-data">
                                        <table class="table table-striped" style="border: 1px solid #ddddda">
                                            ...
                                            <tbody>                                                
                                                ...
                                                <tr>
                                                    <td><input type="text" class="form-control" placeholder="작품 정보 코드" name="pjcode" id="pjcode" required></td>                                                    
                                                </tr>
                                                <tr>
                                                    <td><input type="text" class="form-control" placeholder="한 줄 설명" name="caption" id="caption" required></td>
                                                </tr>
                                                <tr>	
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div>
                                                            <span>비디오 넣기</span>
                                                            <input type="file" accept="video/*" class="col-8 btn-sm" id="videoUpload" name="video[]">
                                        ...
                                        <div class="row justify-content-end">                                            
                                            <div class="col d-flex justify-content-end">                                                
                                                <button type="button" class="btn-lg" onclick="document.write.submit()">글쓰기</button>
