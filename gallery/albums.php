        ...
        $(document).ready (function(){            
            $("#folderAdd").click(function(){
                $("#folderList").append(
					...
					<input type="text" class="form-control form-control-sm col" placeholder="사진첩 키" name="title_key[]">\
						...
						<div class="modal-body">
							<form method="post" id="modal_form1" action="./folder_edit.php" enctype="multipart/form-data">
								<div>
									...
									<input type="text" class="form-control form-control-sm col-12" placeholder="제목" name="title[]">								
									<input type="text" class="form-control form-control-sm col-6" placeholder="날짜" name="rcday[]">
									<input type="text" class="form-control form-control-sm col-6" placeholder="설명" name="caption[]">
									</div>
								</div>
