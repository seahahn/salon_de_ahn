...
<html>
	...
	<body class="right-sidebar is-preload">
                                    ...
                                    <form action="write_ok.php" method="post" enctype="multipart/form-data">
                                        <table class="table table-striped" style="border: 1px solid #ddddda">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>	
                                                    <td><textarea class="form-control ckeditor" placeholder="글 내용" name="content" id="ucontent" style="height: 350px" required></textarea></td>                                                    
        ...
        <!-- HTML 텍스트 에디터(Summernote) 추가-->
            ...
            <!-- CKEditor4의 적용 스크립트 (Full Package 다운로드 기준) -->

            <script type="text/javascript" src="../ckeditor/ckeditor.js"></script>
            <!-- <script type="text/javascript">
            function setEditor() {
                CKEDITOR.config.width = '100%';
                CKEDITOR.config.height = $('textarea[name="content"]').height();
                ...
                CKEDITOR.replace('content', {
                    ...
                    filebrowserImageUploadUrl: './editor_upload.php?path=../image',
                    comma: ''
                });
            }
