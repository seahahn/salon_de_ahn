							...
							<div class="col-12" id="content">
								...
								<table class="table table-sm">
                                    ...
                                    if(isset($unum)){
                                        ...
                                        $sql = mq("SELECT * FROM board_ahn WHERE category='".$category."' AND sub_ctgr='".$lang."'");
                                    } else {
                                    ...
                                    if(isset($unum)){
                                        ...
                                        $sql2 = mq("SELECT * FROM board_ahn WHERE category='".$category."' AND sub_ctgr='".$lang."' ORDER BY in_num DESC, wdate ASC LIMIT $page_start, $list");
                                    } else {
